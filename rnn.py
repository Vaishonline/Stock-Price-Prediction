...
# Importing the Data part
dataset = pd.read_csv('GOOG.csv')
dataset.shape
training_data=dataset[:dataset.shape[0]-20]
...
# Part 2 - Building the RNN(Recurrent Neural Network)
...
dataset_test = dataset[dataset.shape[0]-20:]
